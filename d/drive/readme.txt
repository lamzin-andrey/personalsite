...
9 Мультизагрузка.
 9.1 Сделать pbar классным. И сделать две шкалы прогресса.
 9.2 Второй прогресс бар сделать с учетом Sum(files[N].size)
 9.3 Скрипт аплоада сделать аплоадящим файлы по очереди.
