...
3.1 Локализация экранов добавления и шеринга.							*
...
4.1 Локализация экрана скачивания (кнопку надоть)

4.2 Пофиксить баг с Не именеем прав при смене локализации (права - есть!)
...
И я решил создать 
ряд приложений и сервисов, главной фишкой которых будет то, что они
