...
1 Пункт "Ссылка на файл" в меню файла.									*
  ...
  Загрузки на этом экране не будет, так как придется запрашивать список
   пользователей перед показом экрана.
  В виде фичи можно не делать этого если  public.
  Но ссылку всё равно запрашивать.
  Поэтому делать всегда.
