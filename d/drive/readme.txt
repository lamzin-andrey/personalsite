Итак, проблема с восстановлением пароля.
Что нужно.
 1 Пусть апдейтер всегда добавляет в адрес текущую версию.
 2 Добавить кеш конфиг и сервис воркенр
...
Что касается перекидывания после регистрации на другой хост 
 если захочу, сделаю.
 
 Любопытно было бы попробовать запихать это на хироку.
 

Но кажется, надо смотреть в сторону простой установки на сервак
 и распостранять как продукт.


Вопиющие баги:
 Заходишь на страницу, грузишь файл и получаешь 
  Invalid CSRF Token
   - актуально только для a2 так что можно не особо париться.
   Разве что ради себя.
  
 Надо при запросе свободного места получать актуальный и
  освежать.


GOTO  5

6 Надо сделать экран с выбором версий. Список, 	*
	описание, подсветка, 	какой сейчас активный.	*
	
Нужна английская версия и выбор языков.						*
   Для смены языков делаем два флага вверху по центру.
Всё остальное + / - просто.
   

7 Надо сделать логин по email										*
 Вводишь email, тебе отправляется письмо с ссылкой.
 При переходе - логин.
 
 Делается в ветке try_force_login. Самое сложное понято и сделано.
 
8 Из всего что не a2 надо выпилить пункт Leave WebUSB				*

9 Добавить проверку es6

10 Пилить нормальную Desktop версию.
...
начиная от android 2 и Windows XP и заканчивая самыми последними 
моделями.
