...
Считаем деньги.
 дедик 6 500 / месяц.
 1000 Гб.
 По 50 Гб - это 200 юзеров. Точнее 198, так как ресурс нужен и для программы.
 
 Чтобы продавать дешевле чем майл (хотим 512 Гб за 1 500 в год)
  нужно, чтобы купили пятеро * 12.
  60 человек.
  А им не хватит места.
  Либо это будет нестабильный отложенный сервис.
  Причем на нестабильный отложенный тоже ресурса не хватает (где я 31Тб возьму?)
  Допустим в том же облаке.
  И тогда не надо мне тратить по 6 500 в месяц.
  Достаточно потратить 2000 в год.
  Допустим удастся написать бота, который будет мимикрировать под юзера и допустим его даже не забанят 
  (а что, я же платный клиент).
  
  Кажется, проще сделать доступ к Моему миру.
  Пока это возможно по полной программе. Кажется.
  А если это будет мой аккаунт?
