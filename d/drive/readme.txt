...
11 Авторизация через соц. сети.
   ...
   - Есть. Далее, когда всё по авторизации через соц. сети будет готово, авторизацию сделать по сути как в changeUserAction.
    ...
    Две таблицы. 
    1. Справочник, какие соц сети используются.
    2. id в соцсети, ausers.user_id, socnet_id, hash
    hash возможно не нужен, если это всё работает так, как я помню.
   
   
   И не забудь отправить сообщение, что реклама на Домашнем по субботам в 20 35
