...
1 Динамическая локализация сообщений валидации из сущностей.

https://symfony.com/doc/current/event_dispatcher.html
в нем меня интересует
onKernelRequest
а в нем творим все как описано в 
https://symfony.com/doc/current/translation/locale.html

А у меня правда Sym 5.0.3??? - lf? gj [jle ghfdlf/
