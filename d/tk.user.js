 ...
 * TODO
 *  
 * Добавляем страницу регистрации и главную в компилятор.
 * Пишем главную страницу TrollTech (FF only) и завершаем это дело.
 * В список портфолоио - не забыть!
 * 
 * 
 * * Задачи в кронтаб добавлены, проследить, как там дела
 * 
 * Упоминаем про этот прикольный заголовок, который в FF почему-то не работает.
 * 
