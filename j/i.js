...
/***/ "./sources/landcache/sources/js/land_cache_client.js":
/*!***********************************************************!*\
  !*** ./sources/landcache/sources/js/land_cache_client.js ***!
  \***********************************************************/
...
function () {
  ...
  */
  ...
  _createClass(LandCacheClient, [{
    ...
    value: function init() {
      var o = this;
      o.verbose = false; //Заполняется url которые есть на странице и указывают на данный сайт. Заполнение происходит в getAllResources
    ...
    */
    ...
    value: function getAllResources() {
      ...
      aResources = [],
          ...
          o = this;
      o._aUrlMap = {};
      aImg = jquery__WEBPACK_IMPORTED_MODULE_0___default()('img');
      aStyles = jquery__WEBPACK_IMPORTED_MODULE_0___default()('link[rel=stylesheet]');
      aScripts = jquery__WEBPACK_IMPORTED_MODULE_0___default()('script');
      aMusic = jquery__WEBPACK_IMPORTED_MODULE_0___default()('audio');
      aVideo = jquery__WEBPACK_IMPORTED_MODULE_0___default()('video');
      aSources = jquery__WEBPACK_IMPORTED_MODULE_0___default()('source');
      aResources.push(s);
      o._aUrlMap[s] = 1;
      ...
      sHost = s.split('/')[2];
      if (o.verbose) console.log('detected host', sHost); //Насчет sources (а также video и music) погорячился, если оно большое, то 206 ошибка.
      //А если хоть один из запросов, в массиве который передаётся addAll получит не 200  - ни один не будет добавлен в кэш

      for (i = 0; i < nSzImg; i++) {
        //images
        o._addResource(aResources, aImg[i], 'src', sHost); //styles


        o._addResource(aResources, aStyles[i], 'href', sHost); //scripts


        o._addResource(aResources, aScripts[i], 'src', sHost); //music
      ...
      if (o.verbose) console.log('cacheclient create res list', aResources); //aResources.push('https://andryuxa.ru/404.php');
    ...
    */
    ...
    value: function _addResource(aResources, oItem, sAttrName, sHost) {
      ...
      if (oItem) {
        co = jquery__WEBPACK_IMPORTED_MODULE_0___default()(oItem);
...
/* harmony default export */ __webpack_exports__["default"] = (LandCacheClient);

/***/ }),

/***/ "./sources/sploginpagecacheclient/app.js":
/*!***********************************************!*\
  !*** ./sources/sploginpagecacheclient/app.js ***!
  \***********************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _classes_cachesw__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./classes/cachesw */ "./sources/sploginpagecacheclient/classes/cachesw.js");
window.jQuery = window.$ = window.jquery = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js"); //cache


window.cacheClient = new _classes_cachesw__WEBPACK_IMPORTED_MODULE_0__["default"]();

/***/ }),

/***/ "./sources/sploginpagecacheclient/classes/cachesw.js":
/*!***********************************************************!*\
  !*** ./sources/sploginpagecacheclient/classes/cachesw.js ***!
  \***********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _landcache_sources_js_land_cache_client__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../../landcache/sources/js/land_cache_client */ "./sources/landcache/sources/js/land_cache_client.js");
...
var CacheSw =
/*#__PURE__*/
function (_LandCacheClient) {
  _inherits(CacheSw, _LandCacheClient);

  function CacheSw() {
    _classCallCheck(this, CacheSw);

    return _possibleConstructorReturn(this, _getPrototypeOf(CacheSw).apply(this, arguments));
  }
  ...
  _createClass(CacheSw, [{
    ...
    */
    value: function getExcludeFilterList() {
      var o = new Object();
      o.type = 'filterlist';
      o.data = ['*.jn/', '*.jn', '*.json', this.schemeHost() + '/sp/public/saveprofiledata', this.schemeHost() + '/sp//public/profile', this.schemeHost() + '/sp/public/login', this.schemeHost() + '/sp/public/login_check'];
      return o;
    }
    /**
     * @description Override it Вот это можно перегрузить в наследнике. 
    */
    ...
    key: "showUpdateMessage",
    value: function showUpdateMessage() {} //alert('New version this page available!');
    ...
    */
    ...
    key: "showFirstCachingCompleteMessage",
    value: function showFirstCachingCompleteMessage() {//alert('All resources loaded, add us page on main screen and use it offline.');
    }
  }]);

  return CacheSw;
}(_landcache_sources_js_land_cache_client__WEBPACK_IMPORTED_MODULE_0__["default"]);

/* harmony default export */ __webpack_exports__["default"] = (CacheSw);

/***/ }),

/***/ 1:
/*!*****************************************************!*\
  !*** multi ./sources/sploginpagecacheclient/app.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /opt/lampp/htdocs/mh.loc/www/j/sources/sploginpagecacheclient/app.js */"./sources/sploginpagecacheclient/app.js");
