...
When you append a RuTube video to your site, it slows down the page loading speed for Google.
...
Vue.component('rutube', require('../landlib/vue/2/rutube/rutube.vue'));
```

## Usage 
```html
<rutube video="https://rutube.ru/video/0e6ffd161d5da585ab0cbd3b761f0d3c" img="/i/relaxdemo.jpg" autoplay="false" imageclass="mw-100"></rutube>
```
...
Required.
The hyperlink to the youtube page with video. Copy rutube webpage address, it very just than copy address from iframe code.
