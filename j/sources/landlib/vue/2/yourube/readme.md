...
When you append a RuTube or Youtube video to your site, it slows down the page loading speed for Google.
...
Vue.component('yourube', require('../landlib/vue/2/yourube/yourube.vue'));
```

## Usage 
```html
<yourube ruvideo="https://rutube.ru/video/0e6ffd161d5da585ab0cbd3b761f0d3c" 
youvideo="https://www.youtube.com/watch?v=mFlrc16xjik"
img="/i/relaxdemo.jpg"  autoplay="false" imageclass="mw-100"></yourube>
```
...
Required.
The hyperlink to the youtube page with Rutube video. Copy rutube webpage address, it very just than copy address from iframe code.

#### youvideo attribute

Required.
The hyperlink to the youtube page with Youtube video. Copy rutube webpage address, it very just than copy address from iframe code.
...
Когда вы добавляете видео RuTube на свой сайт, это замедляет скорость загрузки страниц для Google.
Вы можете добавить RuTube iframe на свою веб-страницу и запустить инструмент https://developers.google.com/speed/pagespeed/insights/?hl=ru&url=https%3A%2F%2Fandryuxa.ru%2Fblog%2F для своего сайта. Если вы видите красный индикатор после добавления видео на RuTube, вы можете использовать этот компонент. Его использование позволяет добавлять HTML-код iframe для YouTube после нажатия на «патч» изображение.
...
Необходимый.
Гиперссылка на страницу RuTube с видео. Скопируйте адрес веб-страницы RuTube, это проще, чем скопировать адрес из кода iframe.
