...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__vue_i18n_locales__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__bootstrap421_validators_b421validators__ = __webpack_require__(14);
window.jQuery = window.$ = window.jquery = __webpack_require__(4);
...
Vue.component('b4confirmdlg', __webpack_require__(16));
	...
	mounted: function mounted() {
		...
		if (!this.checkAuthRequestSend) {
			...
			Rest._get(function (data) {
				_this.onSuccessAuthStatus(data);
			}, '/p/trollkiller/checkauth.jn/?p=1', function (a, b, c) {
				_this.defaultFailSendFormListener(a, b, c);
			});
		}
	},
 ...
 */
   ...
   * @param {Object} data
  */
		onSuccessAuthStatus: function onSuccessAuthStatus(data) {
   ...
   * @return Boolean
  */
		onClickManageLink: function onClickManageLink(evt) {
			evt.preventDefault();
			if (this.uid) {
   ...
   * @param {Array} list 
   */
		setExpiriensButtonLabel: function setExpiriensButtonLabel(list) {
   ...
   * @param {Array} list 
   */
		isUseExpiriens: function isUseExpiriens() {
   ...
   * @return Boolean
  */
		onClickUseExpiriens: function onClickUseExpiriens() {
			var _this2 = this;

			var nUid = this.intval(this.uid),
			    nSubjectId = this.intval(this.nPageUserId);

			if (nUid && nSubjectId) {
				if (!this.isUseExpiriens()) {
					Rest._post({ n: nSubjectId }, function (dt) {
						_this2.onSuccessAddRel(dt);
					}, '/p/trollkiller/addrel.jn/', function (a, b, c) {
						_this2.defaultFailSendFormListener(a, b, c);
					});
				} else {
					Rest._post({ n: nSubjectId }, function (dt) {
						_this2.onSuccessDelRel(dt);
					}, '/p/trollkiller/delrel.jn/', function (a, b, c) {
						_this2.defaultFailSendFormListener(a, b, c);
					});
				}
			} else {
				var s = this.$t('app.Wait_load_Data');
				if (!nUid) {
  ...
  */
		onSuccessAddRel: function onSuccessAddRel(data) {
			var _this3 = this;
			...
			this.setExpiriensButtonLabel();
			Rest._get(function (data) {
				_this3.onSuccessAuthStatus(data);
			}, '/p/trollkiller/checkauth.jn/?p=1', function (a, b, c) {
				_this3.defaultFailSendFormListener(a, b, c);
			});
		},
  ...
  */
		onSuccessDelRel: function onSuccessDelRel(data) {
			var _this4 = this;
			...
			this.setExpiriensButtonLabel();
			Rest._get(function (data) {
				_this4.onSuccessAuthStatus(data);
			}, '/p/trollkiller/checkauth.jn/?p=1', function (a, b, c) {
				_this4.defaultFailSendFormListener(a, b, c);
			});
		},
   ...
   * @return Boolean
  */
		onClickManageLinkAuth: function onClickManageLinkAuth() {
  ...
  */
   ...
   */
		...
		_getToken: function _getToken() {
			var ls = document.getElementsByTagName('meta'),
			    i = void 0;
   ...
   * @return Number
  */
		getClientXFromTouchEvent: function getClientXFromTouchEvent(evt) {
   ...
   * @return Object
  */
		storage: function storage(key, data) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__landlib_nodom_validator__ = __webpack_require__(15);
...
var B421Validators = function () {
    ...
    _createClass(B421Validators, null, [{
        ...
        */
        ...
        key: 'equiv',
        value: function equiv(event, jInp, eventType, t, args) {
            var jInp2 = $('#' + args[0]),
                val = '',
                args2 = [];
            if (jInp2[0]) {
        ...
        value: function getValidator() {
            return __WEBPACK_IMPORTED_MODULE_0__landlib_nodom_validator__["a" /* default */];
        }
        /**
...
Component.options.__file = "js/views/b4confirmdialog/b4confirmdlg.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1f4de55a", Component.options)
  } else {
    hotAPI.reload("data-v-1f4de55a", Component.options)
  }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-1f4de55a", module.exports)
  }
}
...
Component.options.__file = "js/views/b4alertdialog/b4alertdlg.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-9a15c44a", Component.options)
  } else {
    hotAPI.reload("data-v-9a15c44a", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-9a15c44a", module.exports)
  }
}
...
Component.options.__file = "js/views/relslistblock.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-9d98d548", Component.options)
  } else {
    hotAPI.reload("data-v-9d98d548", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	props: [],
	computed: {
		aNormalizedRels: function aNormalizedRels() {
			return this.aRels.map(function (element) {
				if (!element.name) {
					element.name = element.dname + ' ' + element.surname;
					element.name = element.name.trim();
				}
				var rating = element.cnt,
				    i = void 0;
				element.imgrating = [];
				for (i = 0; i < 5; i++) {
					if (i < rating) {
   ...
   */
		...
		onClickClosePanel: function onClickClosePanel() {
...
var render = function() {
  ...
  return _vm.isVisible
    ? _c("div", { staticClass: "border border-success mb-5" }, [
          ...
          ? _c("div", { staticClass: "p-4" }, [
              !_vm.isListNoEmpty
                ? _c("div", { staticClass: "alert alert-success" }, [
                    _c("p", [
                      _vm._v(
                        "Вы ещё не используете опыт ни одного из пользователей сайта."
                      )
                    ]),
                    _vm._v(" "),
                    _vm._m(1),
                    ...
                    _c("p", [
                      _vm._v(
                        "\n\t\t\t\tЕсли вам нравится, кого банит тот или иной троллеборец ©.\n\t\t\t\tвы можете  нажать на кнопку «Использовать этот опыт».\n\t\t\t"
                      )
                    ]),
                    _vm._v(" "),
                    _vm._m(2),
                    ...
                    _c("p", [
                      _vm._v(
                        "\n\t\t\t\tВы сможете в любой момент перестать использовать чужой опыт, нажав на ссылку «Управление»\n\t\t\t\tв "
                      ),
                      _c(
                        "a",
                        {
                        ...
                        [_vm._v("главном меню TrollKiller")]
                      ),
                      _vm._v(
                        " и отписавшись от дальнейшего использования.\n\t\t\t"
                      )
                    ])
                  ])
                : _vm._e(),
              ...
              _c("div", [
                _c(
                  ...
                  _vm._l(_vm.aNormalizedRels, function(user) {
                    return _c(
                      "li",
                      { staticClass: "w100 border-bottom pb-2 mb-2" },
                      [
                        _c("div", { staticClass: "media" }, [
                          _c("img", {
                            staticClass:
                              "f-left d-inline-block mr-2 rounded-circle",
                            staticStyle: {
                              "max-width": "45px",
                              "max-height": "45px"
                            },
                            attrs: { src: user.imgpath }
                          }),
                          _vm._v(" "),
                          _c("div", { staticClass: "media-body" }, [
                            _c(
                              "div",
                              { staticClass: "d-inline-block mr-2 float-left" },
                              [
                                ...
                                _c(
                                  ...
                                  [
                                    user.cnt > 5
                                      ...
                                      : _vm._e(),
                                    _vm._v(" "),
                                    _vm._l(user.imgrating, function(s) {
                                      return _c("img", {
                                        attrs: {
                                          src: "/i/troll16" + s + ".jpg"
                                        }
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "float-left text-light ml-3" }, [
      _c("h6", { staticClass: "pt-2", attrs: { id: "ktpan" } }, [
        _vm._v("Панель управления TrollKiller")
      ])
    ])
  },
  function() {
    ...
    return _c("p", [
      _vm._v(
        "Для того, чтобы сделать это, вы можете пройти по ссылке \n\t\t\t\t«Список забаненых троллей» на странице\n\t\t\t\t"
      ),
      _c(
        "a",
        { attrs: { href: "/portfolio/web/userscripts/trollkiller/list/" } },
        [_vm._v("Топ-10")]
      )
    ])
  },
  function() {
    ...
    return _c("p", [
      ...
      _c("a", { attrs: { href: "/portfolio/web/userscripts/trollkiller/" } }, [
        _vm._v("TrollKiller")
      ]),
      _vm._v(
