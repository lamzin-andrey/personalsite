var locales = {
    ...
    'ru': {
        'app': {
			...
			//PHD APP admin
			TakeOrder: 'Забрать себе',
			download_psd: 'Скачать PSD',
			UpProcess: 'Ваш файл загружается на сервер конвертации',
			UploadProcess: 'Загружается нак сервер',
			YourFileConverting: 'Ваш файл конвертируется',
			ResultFileds: 'Результат, скрин результата и замечания',
			...
			downloadResultZip: 'Ссылка на архив с результатом',
			UploadResult: 'Загрузить результат',
			SetAsClosed: 'Пометить как закрытую',
			SendResult: 'Отправить результат',
			notices: 'Замечания (в html формате)',
