...
var CacheSw = function (_LandCacheClient) {
	_inherits(CacheSw, _LandCacheClient);

	function CacheSw() {
		_classCallCheck(this, CacheSw);

		return _possibleConstructorReturn(this, (CacheSw.__proto__ || Object.getPrototypeOf(CacheSw)).apply(this, arguments));
	}

	_createClass(CacheSw, [{
		key: 'getExcludeFilterList',
   ...
   * For progressive web
  */
		value: function getExcludeFilterList() {
			var o = new Object();
			o.type = 'filterlist';
			o.data = ['*.jn/', '*.jn'];
			return o;
...
var LandCacheClient = function () {
	function LandCacheClient() {
		_classCallCheck(this, LandCacheClient);
 ...
 */
  ...
  */
		...
		key: 'getAllResourcesHash',
		value: function getAllResourcesHash() {
			var i = void 0,
			    n = 0,
			    o = this;
			for (i in o._aUrlMap) {
  ...
  */
		...
		value: function getAllResources() {
			...
			aResources = [],
			    ...
			    o = this;
			o._aUrlMap = {};
			aImg = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('img');
			aStyles = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('link[rel=stylesheet]');
			aScripts = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('script');
			aMusic = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('audio');
			aVideo = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('video');
			aSources = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('source');
  ...
  */
		...
		key: '_addResource',
		value: function _addResource(aResources, oItem, sAttrName, sHost) {
			var co = void 0,
			    src = void 0,
			    o = this;
			if (o._aUrlMap[src]) {
			...
			if (oItem) {
				co = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(oItem);
  ...
  */
		...
		key: '_isOurHost',
		value: function _isOurHost(src, sHost) {
			if (!src) {
				return false;
			}
			if (src.charAt(0) == '/') {
  ...
  */
		...
		key: 'setExcludeFilter',
		value: function setExcludeFilter() {
			if (window.landCacheWorker) {
  ...
  */
	...
	return LandCacheClient;
}();

/* harmony default export */ __webpack_exports__["a"] = (LandCacheClient);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__landlib_nodom_validator__ = __webpack_require__(17);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
Vue.component('login-form', __webpack_require__(26));
Vue.component('reg-form', __webpack_require__(29));
Vue.component('reset-form', __webpack_require__(32));
...
window.app = new Vue({
    ...
    */
    mounted: function mounted() {
        var safeReferer = this.storage('sReferer');
...
var locales = {
    ...
    'ru': {
        'app': {
            ...
            "ISubscribe": "Я согласен получать email рассылку от Ламзина Андрея Николаевича, вдруг он ещё что полезное напишет",
...
Component.options.__file = "sources/admin/vue/js/views/Loginform.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-f19faa58", Component.options)
  } else {
    hotAPI.reload("data-v-f19faa58", Component.options)
  }
    ...
    methods: {
        ...
        */
        onSuccessLogin: function onSuccessLogin(data, formInputValidator) {
            ...
            var sReferer = this.$root.storage('sReferer');
            if (sReferer) {
...
Component.options.__file = "sources/admin/vue/js/views/Regform.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-535bde82", Component.options)
  } else {
    hotAPI.reload("data-v-535bde82", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        ...
        return _ref = {
            ...
            //Значение email
            email: null
        }, _defineProperty(_ref, 'password', null), _defineProperty(_ref, 'passwordConfirm', null), _defineProperty(_ref, 'agree', null), _defineProperty(_ref, 'subscribe', null), _defineProperty(_ref, 'alertIsVisible', false), _ref;
    },
    //
    methods: {
        /** 
        ...
        */
        onSubmit: function onSubmit(evt) {
            ...
            /** @var {Validator} validator */
            validator = formInputValidator.getValidator();
            if (validator.isValidEmail(this.email) && validator.isValidPassword(this.password) && validator.isRequired(this.displayName) && validator.isRequired(this.displaySurname) && validator.isRequired(this.subscribe) && validator.isEquiv(this.password, [this.passwordConfirm])) {
                this.$root._post({
                    email: this.email,
                    passwordL: this.password,
        ...
        */
        onSuccess: function onSuccess(data, formInputValidator) {
            ...
            this.password = this.passwordConfirm = this.displayName = this.displaySurname = this.agree = this.subscribe = this.email = '';
            $('#regForm')[0].reset();
      ...
      _c("div", { staticClass: "form-group" }, [
        _c("div", { staticClass: "custom-control custom-checkbox small" }, [
          _c("input", {
            ...
            staticClass: "custom-control-input",
            attrs: { type: "checkbox", id: "subscribe", value: "true" },
            domProps: {
              checked: Array.isArray(_vm.subscribe)
                ? _vm._i(_vm.subscribe, "true") > -1
                : _vm.subscribe
            },
            on: {
              change: function($event) {
