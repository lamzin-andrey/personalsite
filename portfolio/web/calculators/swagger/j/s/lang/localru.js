var langRu = {
	...
	"hHiddenAndBkp" : "Показывать скрытые и бэкап файлы",
	"bSearch" : "Искать",
	"No show catalogs" : "Не показывать каталоги",
	"hSrchTrgCtlg" : "Поиск в каталоге",
	"bSearchClose" : "Закрыть",
	"bSave" : "Сохранить",
	"bSaveColors" : "Сохранить",
	"bSaveNColors" : "Сохранить",
	
	"bCloseNColors" : "Закрыть",
	"bCloseColors" : "Закрыть",
	"bClose" : "Закрыть",
	
	"bCalculate" : "Вычислить",
