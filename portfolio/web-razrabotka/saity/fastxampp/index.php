...
ob_start();
?><p class="tright">
<a href="<?=WEBROOT?>/download.php" class="dlink" >—качать архив с утилитой FastXAMPP</a>
</p>
...
<img style="text-align: middle; margin: 5px 27px" src="<?=img('context.png')?>"><br> позвол€ющий быстро запустить или остановить XAMPP.
</p>
