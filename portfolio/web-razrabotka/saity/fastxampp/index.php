...
?><p>FastXAMPP - это утилита дл€ веб-разработчиков, работающих в Linux Ubuntu, делающа€ работу с XAMPP удобнее.</p>
        ...
        <p>
			<a href="#oldVersions" data-toggle="collapse" >Ѕолее ранние версии FastXampp</a>
        </p>
        ...
        <div>ѕо клику на пункте "Ќастройки" по€вл€етс€ диалог добавлени€ или удалени€ сайта на localhost <br>
            <img class="mw-100 py-2" src="<?=img('kde5_sets.jpg')?>">
            <p class="text-center text-small">—криншот настроек FastXAMPP-7.3.12 Kde 5</p>
        </div>
        <div>
            <img class="mw-100 py-2" src="<?=img('kde-sets.png')?>">
            <p class="text-center text-small">—криншот настроек FastXAMPP-7.0.8.0 Kde 4</p>
        </div>
        ...
        <p>
			Ќачина€ с версии 7.3.12 ubuntu также использует системный трей. ≈сли вы хотите использовать диалог со скриншота, вы можете отредактировать файл</p>
