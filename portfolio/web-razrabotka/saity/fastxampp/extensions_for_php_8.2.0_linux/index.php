...
$title = 'Скачать php extension xdebug.so, imagick.so, amqp.so, redis.so, sodium.so и memcached.so для php-8.2.0 (xampp-8.2.0) amd64';
$description = 'Вы можете скачать php расширения xdebug.so, imagick.so, amqp.so, redis.so и memcached.so для php-8.2.0 (xampp-8.2.0) amd64 (linux xubuntu)';
...
<!-- -->
<p class="x-vers">
    memcached.so for linux PHP-8.2.0 архитектуры amd64 (64 разряда)
</p>
...
<p>
<a href="<?=WEBROOT ?>/files/amd64/8.2.0/memcached.so.tar.gz" class="dlink" >Скачать</a>
</p>
<p>SHA256 файла memcached.so.tar.gz:</p>
<div class="border border-info">9449365ceb8423fcd79388d2e1e46ec3bb4c8d294f21a90aa017e825d84e538b</div>
