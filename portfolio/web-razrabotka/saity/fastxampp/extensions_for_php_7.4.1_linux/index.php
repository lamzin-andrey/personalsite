...
$title = 'Скачать php extension imagick.so, xdebug.so и memcached.so для php-7.4.1 (xampp-7.4.11) amd64';
$description = 'Вы можете скачать php расширения imagick.so, xdebug.so и memcached.so для php-7.4.1 (xampp-7.4.1) amd64 (linux ubuntu)';
...
<p class="x-vers">
    imagick.so for linux PHP-7.4.1 архитектуры amd64 (64 разряда)
</p>
...
<p>
<a href="<?=WEBROOT ?>/files/amd64/7.4.1/imagick.so.tar.gz" class="dlink" >Скачать</a>
</p>
<p>SHA256 файла imagick.so:</p>
<div class="border border-info">afb8a7068f5b586e0c992870c7201891c34e2d0a93211bb8c1593e14e813e2b6</div>


<!-- -->
<p class="x-vers">
    xdebug.so for linux PHP-7.4.1 архитектуры amd64 (64 разряда)
</p>

<p>
Распакуйте этот архив в </p>
<p class="folderpath">/opt/lampp/lib/php/extensions/no-debug-non-zts-20180902/</p>
<p>и добавьте строку в файл /opt/lampp/etc/php.ini</p>
<p> <b class="phpinistr"><b class="phpinikey">zend_extension</b>=<b class="phpinival">xdebug.so</b></b></p>
<p>
<a href="<?=WEBROOT ?>/files/amd64/7.4.1/xdebug.so.tar.gz" class="dlink" >Скачать</a>
</p>
<p>SHA256 файла xdebug.so:</p>
...
<p>
<a href="<?=WEBROOT ?>/files/amd64/7.4.1/memcached.so.tar.gz" class="dlink" >Скачать</a>
</p>
