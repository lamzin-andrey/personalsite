	...
	public function resetJson()
	{
		...
		if(!utils_isJs()) {
			...
			if(!$nR) {
				...
				$resp = $req->execute('http://andryuxa.ru/portfolio/web-razrabotka/saity/fastxampp/b/egate.php', ['pwd' => 'rfk6pAnIuR', 'body' => 'Ваш забытый пароль ' . $pwd . '. И не теряйте его больше!', 'email' => $this->email, 'subject' => l('reset-password')]);
				$r = false;
