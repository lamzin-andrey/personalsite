...
/**
 * @class RecordMoveToPage  - перемещение записи-страницы в списке админки с одной страницы на другую
*/
class RecordMoveToPage extends AdminAuthJson {
	public $uid = 0;
