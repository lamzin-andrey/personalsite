...
WHERE m.is_deleted = 1 LIMIT 10, 10; *</li>
			...
			<li>В первой половине дня больше налегаем на создание инструменов, во второй больше пилим рутину
				<ul>
					<li>Файлы в Symfony - описать в статье и порекомендовать своё творчество</li>
