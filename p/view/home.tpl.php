...
<ul>
	<li class="text-error">симфони 3. (очень сомнительное, что то структура файлов не похожа на документацию symfony 3.4, 
		...
		<ul>
			...
			<li>Разобраться, не появилось ли в S4 что-то вместо бандлов для повторного исползования.</li>
	...
	У него чистый html на выдаче, поэтому он классный.</li>
</ul>

<h2>Дела текущие</h2>
<ul class="text-success">
	<li class="text-success">Перенести фастксамп в подраздел хомяка. Не сделать ли хомяком php2js.ru? (в этом году уже поздно, но пусть php2js.ru на всякий случай будет на этом же compileHtml движке.)</li>
