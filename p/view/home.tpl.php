...
<h3>Недоделки</h3>
<ul>
	<li>Понять, что не так с lazyload на странице троллькиллера</li>
...
<ul>
	<li>Обновиться на node (? не npm ? см. чат) 9 </li>
...
<ul>
	...
	<li>Стоит ли перетаскивать бэкенд этого сайта на фреймвёрк?</li>
</ul>
<h2>Что-то старое</h2>
<ul>
