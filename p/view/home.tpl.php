		...
		FOSUserBundle в статье через composer ставится.
				<ul>
					<li>Темизация страница логина, которые не темизированы
						<ul>
							<li> Перегрузить теперь ещё контроллер формы, так как если текущий пароль не пуст,
							...
							<li>Наконец-то перегружаем FOS форму (Form), это круто (/profile/edit). 
								При отключеном sw кэшировании работает на ура. Что радует.
...
<ul>
	...
	<li><ul>
		<li >Разобраться с счётчиками freesoft
			...
			<li ><b class="text-danger">18 11 2019</b> у них были проблемы с редактированием раздела.
