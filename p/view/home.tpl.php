...
<p>
	...
	<ul>
		...
		<li>В табе Добавить и SEO под формами сделать кнопки "Сохранить и закончить редактирование" и "Закончить редактирование" (нужен конфирм для вторых!). Новаю статью возможно создать только после того, как нажата одна из них</li>
