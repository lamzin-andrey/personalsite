...
Vue.component('test-menu', __webpack_require__(7));
    ...
    methods: {
        ...
        */
        ...
        onTouchMove: function onTouchMove(evt) {
            if (this.getClientXFromTouchEvent(evt) - this.startX > 150) {
                this.showMenu();
            }
        },
        ...
        */
        hideMenu: function hideMenu() {
            ...
            setTimeout(function () {
                window.scrollTo(0, _this2.scrollY);
            }, 200);
        },
        ...
        toggleAutoscroll: function toggleAutoscroll() {
            ...
            if (!this.ival) {
                this.ival = setInterval(function () {
                    window.scrollBy(0, _this3.nStep);
        ...
        */
        setStartX: function setStartX(evt) {
        ...
        */
         ...
         * @return Number
        */
        getClientYFromTouchEvent: function getClientYFromTouchEvent(evt) {
            if (evt.changedTouches && evt.changedTouches[0] && evt.changedTouches[0].clientY) {
...
Component.options.__file = "vue/app_sources/js/views/Menu.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-b878352c", Component.options)
  } else {
    hotAPI.reload("data-v-b878352c", Component.options)
  }
...
var render = function() {
  ...
  return _c("div", { attrs: { id: "menuBar" } }, [
    _vm.isMainMenuVisible
      ...
      : _vm._e(),
    _vm._v(" "),
    _vm.isScrollWndVisible
      ? _c("div", { attrs: { id: "scrollSettingWnd" } }, [
          _c(
            "div",
                ...
                directives: [
                  {
                    name: "model",
                    rawName: "v-model",
                    value: _vm.$root.nStep,
                    expression: "$root.nStep"
                  }
                ],
                attrs: { type: "number" },
                domProps: { value: _vm.$root.nStep },
                on: {
                  input: function($event) {
                    if ($event.target.composing) {
                      return
                    }
                    _vm.$set(_vm.$root, "nStep", $event.target.value)
                  }
                }
              })
            ])
                ...
                directives: [
                  {
                    ...
                    rawName: "v-model",
                    value: _vm.$root.nInt,
                    expression: "$root.nInt"
                  }
                ],
                attrs: { type: "number" },
                domProps: { value: _vm.$root.nInt },
                on: {
                  input: function($event) {
                    if ($event.target.composing) {
                      return
                    }
                    _vm.$set(_vm.$root, "nInt", $event.target.value)
                  }
                }
              })
            ])
                ...
                directives: [
                  {
                    name: "model",
                    rawName: "v-model",
                    value: _vm.$root.bookFontSize,
                    expression: "$root.bookFontSize"
                  }
                ],
                attrs: { type: "number" },
                domProps: { value: _vm.$root.bookFontSize },
                on: {
                  input: function($event) {
                    if ($event.target.composing) {
                      return
                    }
                    _vm.$set(_vm.$root, "bookFontSize", $event.target.value)
                  }
                }
              })
            ])
          ...
          _c("input", {
            ...
            on: { click: _vm.onClickSaveScrollData }
          })
        ])
      : _vm._e(),
    _vm._v(" "),
    _vm.isColorWndVisible
      ? _c("div", { attrs: { id: "colorSettingWnd" } }, [
          _c(
            "div",
            { staticClass: "menuItem", on: { click: _vm.onClickGotoMainMenu } },
            [_vm._v("Назад")]
                ...
                directives: [
                  {
                    name: "model",
                    rawName: "v-model",
                    value: _vm.$root.bookBg,
                    expression: "$root.bookBg"
                  }
                ],
                attrs: { type: "color" },
                domProps: { value: _vm.$root.bookBg },
                on: {
                  input: function($event) {
                    if ($event.target.composing) {
                      return
                    }
                    _vm.$set(_vm.$root, "bookBg", $event.target.value)
                  }
                }
              })
            ])
              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.$root.bookColor,
                  expression: "$root.bookColor"
                }
              ],
              attrs: { type: "color" },
              domProps: { value: _vm.$root.bookColor },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.$root, "bookColor", $event.target.value)
                }
              }
            })
          ]),
          ...
          _c("input", {
            attrs: { type: "button", value: "Save" },
            on: { click: _vm.onClickSaveColorData }
          })
        ])
      : _vm._e(),
    _vm._v(" "),
    _vm.isHelpWndVisible
      ? _c("div", { attrs: { id: "colorSettingWnd" } }, [
          _c(
            "div",
            { staticClass: "menuItem", on: { click: _vm.onClickGotoMainMenu } },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-b878352c", module.exports)
  }
}
