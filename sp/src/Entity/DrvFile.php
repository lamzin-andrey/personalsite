...
class DrvFile
{
    ...
    */
     ...
     *     nullable=false,
     *     options={
     *     "comment"="  1 если успешный public,
     *                  2 - если не найден на локале,
     *                  3 - загружен, но не опубликован,
     *                  4 - удален в webDav спустя пол-года,
     *                  5 - не надо двигать на диск, файл админский и является частью приложения,
     *                  6 - надо распубликовать, так как файл удален", "default"="0"})
     */
